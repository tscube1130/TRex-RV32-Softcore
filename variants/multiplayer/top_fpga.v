...
module top_fpga #(
    ...
    // --- NEW MULTIPLAYER PORTS ---
    input  wire        sw_role,         // Maps to SW[15] (UP = Host, DOWN = Client)
    output wire        pmod_ja1_tx,     // Pin 1 is ALWAYS Transmit
    input  wire        pmod_ja2_rx,     // Pin 2 is ALWAYS Receive
   ...
   wire [1:0]  audio_ev;
    ...
    mmio_decoder u_mmio (
        ...
        // --- NEW MMIO CONNECTIONS ---
        .net_tx_o         (pmod_ja1_tx),
        .net_rx_i         (pmod_ja2_rx),
        .sw_role_i        (sw_role)
    );
